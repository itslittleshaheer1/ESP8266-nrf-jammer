...
void loop() {
  for (int currentChannel = 0; currentChannel < numBluetoothChannels; currentChannel++) {
    ...
    // Delay between channel transmissions
    delay(10);  // Adjust this delay for faster or slower cycling
  }
}
